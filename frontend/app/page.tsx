    ...
    <div className="bg-background text-foreground overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20 px-4 overflow-hidden" id="home">
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          />
          <motion.div
            className="absolute bottom-20 left-10 w-80 h-80 bg-blue-500/15 dark:bg-blue-600/20 rounded-full blur-3xl"
            animate={{ y: [0, -30, 0], x: [0, -20, 0] }}
            transition={{ duration: 10, repeat: Infinity }}
          />
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={containerVariants} initial="hidden" animate="visible">
              ...
              <motion.h1
                variants={itemVariants}
                className="text-5xl md:text-6xl font-bold font-poppins mb-6 leading-tight text-foreground"
              >
                Protect Your Organization from
                <span className="bg-gradient-to-r from-purple-500 via-purple-600 to-blue-500 bg-clip-text text-transparent">
                  {' '}Social Engineering Attacks
                </span>
              </motion.h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-purple-600 dark:text-purple-300 font-medium">Complete Platform</span>
            </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className={`group p-8 rounded-xl bg-card border ${feature.border} hover:border-purple-400/50 hover:shadow-lg transition-all`}
              >
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center mb-6`}>
                  <feature.icon className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-lg font-semibold font-poppins mb-3 text-foreground">{feature.title}</h3>
      ...
      {/* ───────────────── HOW IT WORKS ───────────────── */}
      <section className="py-24 px-4 bg-background" id="howitworks">
        <div className="max-w-7xl mx-auto">
          <motion.div
            variants={containerVariants}
            initial="hidden"
          ...
          >
            {[
              ...
              <motion.div key={idx} variants={itemVariants} className="relative">
                <div className="p-6 rounded-xl bg-card soft-border hover:border-purple-500/30 hover:border-purple-400/40 hover:shadow-md transition-all h-full">
                  <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-4">
                    {item.step}
                  </div>
                  <h3 className="text-lg font-semibold font-poppins mb-3 text-foreground">{item.title}</h3>
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{ y: -6, transition: { duration: 0.2 } }}
                className="p-8 rounded-xl bg-card soft-border hover:border-purple-500/30 hover:border-purple-400/40 hover:shadow-lg transition-all"
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
                    {t.initials}
                  </div>
                  <div>
